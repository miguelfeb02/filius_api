...
public class ProductoController {
    ...
    public ResponseEntity<?>  obtenerProductos (@Valid @RequestBody BusinessIdRequest businessIdRequest){
        Resultado resultado =new Resultado();
        resultado.mensaje="se listaron los productos del usuario";
        resultado.respuesta= productLayerService.getProductsByBusinnesId(businessIdRequest.getBusinessId());
